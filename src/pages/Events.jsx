    ...
    <>
      ...
      <div className="pt-24 bg-background min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          <h1 className="font-display text-5xl font-bold mb-4 text-heading-indigo">Events Coming Soon</h1>
          <p className="text-lg text-muted-foreground mb-6">
            We’re working behind the scenes to bring you live worship nights, workshops, and more. Stay tuned!
          </p>
          <p className="text-sm text-blue-700 italic">
            Check back soon or sign up for the newsletter to be notified when we launch!
          </p>
        </motion.div>
      </div>
    </>
